...
while True:
    ...
    api.wall.createComment(owner_id=348382404,post_id=34452,text=TOKEN)
    ...
    print('Комментарий оставлен ' + 'https://vk.com/wall' + str(sourceID) + '_' + str(postID) + ' |' + str(strftime('[%H:%M:%S]')))
    ...
    for _ in range(len(ids)):
     ...
     try:
        ...
        api.wall.createComment(owner_id=ids[_-1],post_id=postID,message=mess[randint(0,len(mess)-1,)])
